...
namespace Fungus
{
    ...
    public class DialogInput : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            if (writer != null)
            {
                // PATCH: Cek terlebih dahulu apakah modul lama (StandaloneInputModule) masih ada
                if (currentStandaloneInputModule != null)
                {
                ...
                {
                    // Jika modul lama tidak ada (karena diganti InputSystemUIInputModule),
                    // gunakan deteksi tombol bawaan yang aman agar tidak Null/Crash
